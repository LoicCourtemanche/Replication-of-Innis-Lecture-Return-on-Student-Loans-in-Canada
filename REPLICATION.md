...
- [Set the current directory to the path of the global created](https://github.com/LoicCourtemanche/Replication-of-Innis-Lecture-Return-on-Student-Loans-in-Canada/commit/04a4911b08724b40d53c3cd406ce31b34f2178f8#diff-c95c37aed6daf950cee5bc9390fb054b62bc3abac7f78b5bdd7d098ec6b2554cR6-R36)
...
- [Make all variable names lowercase](https://github.com/LoicCourtemanche/Replication-of-Innis-Lecture-Return-on-Student-Loans-in-Canada/compare/master...Replication#diff-a00236df0f97886f4dea47e57483a1ce4bc27ce36a7468afbd478881c9236534R8-R11)
...
- We run two robustness tests. For the first one, we change the value of the "rrate" (the interest rate of the loan) used to calculate the prediction of payments in "preict_payments" do-file. The authors do not explain why they use this rate. [We make a loop over those three sub-program] predict_payments, calc_return and return_analysis to produce results for "rrate" of 0.045, 0.05, 0.055, 0.06 and 0.065 (the value used by the article is 0.055).(https://github.com/LoicCourtemanche/Replication-of-Innis-Lecture-Return-on-Student-Loans-in-Canada/compare/master...Improvement#diff-c95c37aed6daf950cee5bc9390fb054b62bc3abac7f78b5bdd7d098ec6b2554cR107-R124) The article used the 2005 cohorts to evaluate the rate of return. [We make an other loop](https://github.com/LoicCourtemanche/Replication-of-Innis-Lecture-Return-on-Student-Loans-in-Canada/blob/Improvement/dataverse_files/main.do#L119-L123) inside the first one mention before to change the cohorts use to produce results for all cohorts availables (2003 to 2008) to see if the conclusion hold for the others cohorts.
...
2. Modify the "main.do" file:
  ...
  - [Set the current directory to the path of the global created](https://github.com/LoicCourtemanche/Replication-of-Innis-Lecture-Return-on-Student-Loans-in-Canada/compare/master...Improvement#diff-c95c37aed6daf950cee5bc9390fb054b62bc3abac7f78b5bdd7d098ec6b2554cR6-R36)
